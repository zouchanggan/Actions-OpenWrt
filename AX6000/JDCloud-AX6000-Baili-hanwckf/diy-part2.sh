...
mkdir -p package/passwall-packages/luci-app-openclash/root/etc/openclash/core
mv /tmp/clash package/passwall-packages/luci-app-openclash/root/etc/openclash/core/clash >/dev/null 2>&1

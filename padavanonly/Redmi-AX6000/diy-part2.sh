...
# 替换软件&依赖
cp -rf package/small/shadowsocks-rust package/helloworld
cp -rf package/SSRP/update/v2raya package/helloworld
cp -rf package/passwall/luci-app-passwall package/helloworld
cp -rf package/passwall2/luci-app-passwall2 package/helloworld
cp -rf package/small/luci-app-mosdns package/helloworld
cp -rf package/small/mosdns package/helloworld
cp -rf package/small/v2dat package/helloworld
